...
export class BlockEditor implements OnChanges, DoCheck {
      ...
      this.form.patchValue(
        {
          ...
          repeterEnTeteChaquePage: this.block.repeterEnTeteChaquePage ?? true,
          eviterCoupureLignes: this.block.eviterCoupureLignes ?? true,
  ...
  save(): void {
    ...
    let updatedBlock: DesignBlock = {
      ...
      repeterEnTeteChaquePage: val.repeterEnTeteChaquePage ?? true,
