...
public class TemplateController {
    ...
    public ResponseEntity<TemplateResponse> publish(@PathVariable UUID id) {
        return ResponseEntity.ok(templateService.publish(id));
    }

    // ---------- Variables ----------
    @GetMapping("/{templateId}/variables")
    public ResponseEntity<List<VariableResponse>> getVariables(@PathVariable UUID templateId) {
        return ResponseEntity.ok(variableService.getVariables(templateId));
    }

    @PostMapping("/{templateId}/variables")
    public ResponseEntity<VariableResponse> addVariable(@PathVariable UUID templateId,
    ...
    public ResponseEntity<Void> deleteVariable(@PathVariable UUID templateId,
    ...
    public ResponseEntity<TemplateSchemaDto> schema(@PathVariable UUID id) {
    ...
    public GenerationResponse generateAsync(@PathVariable UUID id,
                                            @RequestBody Map<String, Object> data) {
    ...
    public ResponseEntity<List<GenerationDto>> generations(@PathVariable UUID id) {
